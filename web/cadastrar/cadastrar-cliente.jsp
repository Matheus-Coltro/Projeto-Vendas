    ...
    <center>
        <h1>Cadastro de Cliente</h1>
           <form method="POST" action="CadastrarCliente">
               ...
               <input class="form-style" value="${cliente.nomec}" placeholder="Nome" type="text" name="nomec"><br>
               <input class="form-style" value="${cliente.cpf}" placeholder="CPF" type="text" name="cpf"><br>
               <input class="form-style" value="${cliente.telefone}" placeholder="Telefone" type="text" name="telefone"><br>
